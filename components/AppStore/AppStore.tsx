      ...
      <section className="py-6  text-gray-900" style={{ backgroundColor: "#125875d9" }}>
        <div className="container mx-auto flex flex-col justify-around p-4 text-center md:p-10 lg:flex-row">
          <div className="flex flex-col justify-center lg:text-left">
            <p className="mb-1 text-sm font-medium tracking-widest uppercase text-white">Best rated app for students</p>
            <h1 className="py-2 text-3xl font-medium leading-tight title-font text-white">University App</h1>
          </div>
