...
const Feautures = () => {
    return (
        <div className='mt-20'>        
            <div className={`${styles.features_main} flex flex-col lg:flex-row py-12 w-full `}>
                ...
                <div className=''>
                    <img src="https://wpdemo.zcubethemes.com/qeducato/wp-content/uploads/2023/03/steps-img.png" className='w-full' alt="" />
